"""
Django settings for refugio_api project.
"""
import os
...
# ALLOWED_HOSTS para Railway y desarrollo local
...
# CORS Settings
# En producción, CORS_ALLOWED_ORIGINS debe ser configurado con las URLs exactas del frontend
CORS_ALLOWED_ORIGINS = env.list(
    'CORS_ALLOWED_ORIGINS',
    default=['http://localhost:5173', 'http://localhost:3000']
)

# Permitir todos los orígenes en desarrollo (solo si DEBUG=True)
if DEBUG:
